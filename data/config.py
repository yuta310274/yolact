...
my_custom_dataset = dataset_base.copy({
    ...
    'train_images': './data/strawberry_coco_1.v1i.coco-segmentation/train',
    'valid_images': './data/strawberry_coco_1.v1i.coco-segmentation/valid',

    'train_info': './data/strawberry_coco_1.v1i.coco-segmentation/train/_annotations.coco.json',
    'valid_info': './data/strawberry_coco_1.v1i.coco-segmentation/valid/_annotations.coco.json',

    'has_gt': True,
    'class_names': ('R_strawberry','people',),
    'label_map' : {1:1 , 2:2}
})
...
coco_base_config = Config({
    ...
    'augment_expand': True,
    # Potentialy sample a random crop from the image and put igle colaboratoryt in a random place
...
yolact_resnet50_strawberry_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_strawberry',
